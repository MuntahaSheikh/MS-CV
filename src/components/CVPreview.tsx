...
import { Printer, Copy, FileDown, Check, Mail, Phone, MapPin, Globe, Landmark, Award, X, Info } from "lucide-react";
            ...
            <div>
              ...
              <div className="h-[140px] flex items-center justify-between border-b border-slate-200 pb-3">
                <div className="flex flex-col justify-center h-full">
                  ...
                  <div className="mt-1.5 flex items-center gap-1 text-[11.5px] text-slate-500 font-medium font-sans">
              ...
              <div className="mt-8">
                ...
                <p className="mt-3 text-[11.5px] leading-relaxed text-slate-700 text-justify font-sans">
                  {cvData.summary}
                </p>
              </div>
              ...
              {cvData.honors && cvData.honors.length > 0 && (
                <div className="mt-10">
                  ...
                  <div className="space-y-5">
                    {cvData.honors.map((h, index) => (
                      <div key={index} className={`flex gap-4 items-start p-4 border ${theme.accentBorder} rounded-xl ${theme.highlight}/40`}>
                        <div className={`p-2 border ${theme.accentBorder} rounded-lg ${theme.accentBg} ${theme.accentText} shrink-0`}>
                          <Award size={16} />
                        </div>
                        <div>
                          <h3 className="font-display font-black text-[13px] text-slate-950 uppercase tracking-wide">
                            {h.title}
                          </h3>
                          <p className="mt-1 text-[11px] leading-relaxed text-slate-655 text-justify font-sans">
                            {h.description}
                          </p>
                        </div>
                      </div>
            ...
            <div>
              ...
              <div className="h-[40px] flex items-center justify-between border-b border-slate-200 pb-2 mb-4">
                ...
                <span className={`font-sans font-semibold text-[9.5px] ${theme.accentText} uppercase tracking-wider`}>
                  03 – 04 / Core Competencies &amp; Architectural Focus
                </span>
              </div>
